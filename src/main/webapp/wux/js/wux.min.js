...
return a.rootTag="canvas",a.title="",a._opset=!1,a.legend="pie"==r||"doughnut"==r||"polarArea"==r,a.colors=[],a.bg0=t.global.chart_bg0,a.bg1=t.global.chart_bg1,a.bg2=t.global.chart_bg2,a.bc0=t.global.chart_bc0,a.bc1=t.global.chart_bc1,a.bc2=t.global.chart_bc2,a.p0=t.global.chart_p0,a.p1=t.global.chart_p1,a.p2=t.global.chart_p2,a.pbc="#fff",a.forceOnChange=!0,a}return __extends(n,e),Object.defineProperty(n.prototype,"options",{get:function(){return this._options},set:function(t){this._options=t,this._opset=!!t},enumerable:!0,configurable:!0}),n.prototype.componentDidMount=function(){this._tooltip&&this.root.attr("title",this._tooltip),this.state&&this.buildChart()},n.prototype.buildChart=function(){if(this.state&&this.root){this.state.labels||(this.state.labels=[]),this.state.titles||(this.state.titles=[]),this.state.series||(this.state.series=[[]]),this.props||(this.props="line"),this._opset&&this._options||("pie"==this.props||"doughnut"==this.props||"polarArea"==this.props?this.legend=!0:this.state.titles&&this.state.titles.length||this.title||(this.legend=!1),this._options={responsive:!0,maintainAspectRatio:!1,legend:{display:this.legend}})
var t
if("pie"==this.props||"doughnut"==this.props||"polarArea"==this.props)this.colors&&this.colors.length||(this.colors=["#dfefdf","#e4f4ff","#ffffcc","#ffddaa","#ffccff","#e6ccff","#f1e7cb","#eeeeee","#d9f2e6","#d9e6f2"]),t={labels:this.state.labels,datasets:[{backgroundColor:this.colors,data:this.state.series[0]}]}
else{for(var e=[],n=0;n<this.state.series.length;n++){var r=this.state.titles[n]
r||(r=""),e.push({label:r,backgroundColor:0==n?this.bg0:1==n?this.bg1:this.bg2,borderColor:0==n?this.bc0:1==n?this.bc1:this.bc2,pointBackgroundColor:0==n?this.p0:1==n?this.p1:this.p2,pointBorderColor:this.pbc,data:this.state.series[n]})}t={labels:this.state.labels,datasets:e}}this.chart=new Chart(this.root[0].getContext("2d"),{type:this.props,data:t,options:this._options})}},n}(t.WComponent)

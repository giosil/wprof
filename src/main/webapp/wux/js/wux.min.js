...
i&&t.addClass(i),r&&t.css(m(r))}return t}function A(t,e,n,r,i,o){if(!t)return""
e||(e=""),n||(n="")
var s=o?' title="'+o+'"':""
return i=i?" "+i:"",t.indexOf(".")>0?e+'<img src="'+t+'"'+s+">"+n:!r||r<2?e+'<i class="fa '+t+i+'"'+s+"></i>"+n:(r>5&&(r=5),e+'<i class="fa '+t+" fa-"+r+"x"+i+'"'+s+"></i>"+n)}function D(e,n,r,i,o,s){e||(e="div")
var a,l
...
u&&(h+=" "+u),h+=">"
var p=d(n)
return h+=p[1],"input"==e?p[0]+h+p[2]:(h+="</"+e+">",p[0]+h+p[2])}function k(e,n,r,i){if(!e||!n)return e
...
var u=$(l)
return n.element=u,r&&e.append(r),e.append(u),i&&e.append(i),n.wrapper?t.addWrapper(u,n.wrapper,n.begin,n.end):(n.begin&&u.append(n.begin),n.end&&u.append(n.end),u)}function E(e,n){if(e){if("string"==typeof e){if(e.indexOf("<")>=0)return
e.indexOf("#")<0&&(e="#"+e)
...
t.RES=M}(WUX||(WUX={}))
var WUX
!function(t){var e=function(e){function n(n,r,i,o,s){var a=e.call(this,n,"WChartJS",r,i,o,s)||this
return a.rootTag="canvas",a.title="",a._opset=!1,a.legend="pie"==r||"doughnut"==r||"polarArea"==r,a.colors=[],a.bg0=t.global.chart_bg0,a.bg1=t.global.chart_bg1,a.bg2=t.global.chart_bg2,a.bc0=t.global.chart_bc0,a.bc1=t.global.chart_bc1,a.bc2=t.global.chart_bc2,a.p0=t.global.chart_p0,a.p1=t.global.chart_p1,a.p2=t.global.chart_p2,a.pbc="#fff",a.forceOnChange=!0,a}return __extends(n,e),Object.defineProperty(n.prototype,"options",{get:function(){return this._options},set:function(t){this._options=t,this._opset=!!t},enumerable:!1,configurable:!0}),n.prototype.onClickChart=function(t){t&&(this.handlers._click||(this.handlers._click=[]),this.handlers._click.push(t))},n.prototype.getLabel=function(e){if(!this.state)return""
if(!e||!e.data)return""
var n=e.data.split("_"),r=t.WUtil.toNumber(n[n.length-1])
return t.WUtil.toString(this.state.labels[r])},n.prototype.getValue=function(e){if(!this.state)return 0
if(!e||!e.data)return 0
var n=e.data.split("_"),r=n.length>1?t.WUtil.toNumber(n[0]):0,i=t.WUtil.toNumber(n[n.length-1])
return this.state.series[r][i]},n.prototype.componentDidMount=function(){this._tooltip&&this.root.attr("title",this._tooltip),this.state&&this.buildChart()},n.prototype.buildChart=function(){var e=this
if(this.state&&this.root){this.state.labels||(this.state.labels=[]),this.state.titles||(this.state.titles=[]),this.state.series||(this.state.series=[[]]),this.props||(this.props="line"),this._opset&&this._options||("pie"==this.props||"doughnut"==this.props||"polarArea"==this.props?this.legend=!0:this.state.titles&&this.state.titles.length||this.title||(this.legend=!1),this._options={responsive:!0,maintainAspectRatio:!1,onClick:function(n,r){var i=e.chart.getElementAtEvent(n)
if(i&&i.length){var o=t.WUtil.getString(i[0],"_datasetIndex",""),s=t.WUtil.getString(i[0],"_index","")
e.trigger("_click",o+"_"+s)}},legend:{display:this.legend}})
var n
if("pie"==this.props||"doughnut"==this.props||"polarArea"==this.props)this.colors&&this.colors.length||(this.colors=["#dfefdf","#e4f4ff","#ffffcc","#ffddaa","#ffccff","#e6ccff","#f1e7cb","#eeeeee","#d9f2e6","#d9e6f2"]),n={labels:this.state.labels,datasets:[{backgroundColor:this.colors,data:this.state.series[0]}]}
else{for(var r=[],i=0;i<this.state.series.length;i++){var o=this.state.titles[i]
o||(o=""),r.push({label:o,backgroundColor:0==i?this.bg0:1==i?this.bg1:this.bg2,borderColor:0==i?this.bc0:1==i?this.bc1:this.bc2,pointBackgroundColor:0==i?this.p0:1==i?this.p1:this.p2,pointBorderColor:this.pbc,data:this.state.series[i]})}n={labels:this.state.labels,datasets:r}}this.chart=new Chart(this.root[0].getContext("2d"),{type:this.props,data:n,options:this._options})}},n}(t.WComponent)
...
if(p.attributes?(W+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '+p.attributes,(p.readonly||0==p.enabled)&&(W+=" disabled"),W+=">"):(W+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'"',(p.readonly||0==p.enabled)&&(W+="disabled"),W+=">"),p.options&&p.options.length>0)for(var I=0;I<p.options.length;I++){var R=p.options[I]
W+="string"==typeof R?"<option>"+R+"</option>":'<option value="'+R.id+'">'+R.text+"</option>"}W+="</select>",p.element=$(W)
break
case t.WInputType.Email:var A='<input type="text" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '
...
break
case t.WInputType.Password:var k='<input type="password" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '
p.readonly&&(k+="readonly "),0==p.enabled&&(k+="disabled "),p.style&&(k+=' style="'+t.style(p.style)+'"'),k+="/>",p.element=$(k)
break
case t.WInputType.Cron:var E=""
null!=p.value&&""!=p.value&&(E='initial: "'+p.value+'" ,')
var N='<div id="cron_'+p.id+'" class="'+this.inputClass+'" '
p.readonly&&(N+="readonly "),0==p.enabled&&(N+="disabled "),N+=" ></div>",N+='<script type="text/javascript">$(document).ready(function() {',N+='$("#cron_'+p.id+'").cron({'+E+'onChange: function() {$("#'+p.id+'").val($(this).cron("value"));},useGentleSelect: true});',N+='});<\/script><input type="hidden" name="'+p.id+'" id="'+p.id+'" />',p.element=$(N)
break
...
this.root.append(P)
var H=$('<div class="'+this.footerClass+'"'+M+"></div>")
P.append(H)

...
this.root.append(U)
var M=$('<div class="'+this.footerClass+'"'+N+"></div>")
U.append(M)
for(var F=0,P=this.footer;F<P.length;F++){var H=P[F]
"string"==typeof H&&H.length>0?M.append($(H)):H instanceof t.WComponent?H.mount(M):M.append(H)}}for(var B=this,V=0,j=this.dpids;V<j.length;V++){var X=j[V]
